            ...
            <div class="row m-b-30">
                <div class="col-sm-12">
					...
					<div class="form-group">
						...
						{!! Form::text('dni', '', array('class' => 'form-control input-sm', 'id' => 'dni', 'onkeyup' => 'buscar(\''.$entidad.'\')')) !!}
					</div>

					<div class="form-group">
						{!! Form::label('nombres', 'Nombre:', array('class' => 'input-sm')) !!}
						{!! Form::text('nombres', '', array('class' => 'form-control input-sm', 'id' => 'nombres', 'onkeyup' => 'buscar(\''.$entidad.'\')')) !!}
					</div>
					<div class="form-group">
