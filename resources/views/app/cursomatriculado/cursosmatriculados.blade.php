				...
				<table id="example1" class="table table-bordered table-striped table-condensed table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td>
							{!! Form::button('<div class="glyphicon glyphicon-list"></div> Matriculados', array('onclick' => 'modal (\''.URL::route($ruta["desmatriculados"], $value->id).'\', \''.$titulo_desmatricular.'\', this);', 'class' => 'btn btn-xs btn-success')) !!}
							</td>
						</tr>
						<?php
						$contador = $contador + 1;
