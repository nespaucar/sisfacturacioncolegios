        ...
        <div class="card-box table-responsive">
            ...
            <div class="row m-b-30">
                <div class="col-sm-12">
					...
					<div class="form-group">
						{!! Form::label('menuoptioncategory_id', 'Categoria:', array('class'=>'input-xs')) !!}
						{!! Form::select('menuoptioncategory_id', $cboCategoria, null, array('class' => 'form-control input-xs', 'id' => 'menuoptioncategory_id', 'onchange' => 'buscar(\''.$entidad.'\')')) !!}
					</div>
					<div class="form-group">
